                    ...
                    <table class="table table-bordered table-striped margin-b-none table-responsive">
                        ...
                        <tbody class="form-options-body">
                            ...
                            foreach ($modelDetails as $index => $modelDetail):
                                ...
                                $totalProfit = 0;
                                $totalCom = 0;
                                $totalPrice += $modelDetail->price;
                                $totalAmount += $modelDetail->amount;
                                $totalPeriod += $modelDetail->credit->periodLabel;
                                //$totalProfit = $modelDetail->price * ($model->period * $model->customer->profit / 100);
                                //$totalPriceRow = ($totalProfit + $modelDetail->price) / $model->period;
                                $totalPriceAll += $modelDetail->periodOf;
