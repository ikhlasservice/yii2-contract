                        ...
                        [
                            ...
                            'content' => function($model) {
                                ...
                                switch ($model->status) {
                                    case 3:
                                    case 5:
                                        $str = Html::a('<span class="glyphicon glyphicon-pencil"></span> ดูรายละเอียด', ['/contract/credit/view', 'id' => $model->id], ['class' => 'btn btn-primary']);
                                        break;
                                    case 4:
                                        $str = Html::a('<span class="glyphicon glyphicon-pencil"></span> แก้ไข', ['/contract/credit/create', 'id' => $model->id], ['class' => 'btn btn-danger']);
                                        break;
                                }
                                return $str;
                            },
